...
class RealRailSnapshotServiceTest {
    ...
    fun `getLiveSnapshot returns fresh snapshot then serves cached snapshot`() {
        runBlocking {
            ...
            val snapshotService = RealRailSnapshotService(
                railData,
                StubRailMetadataRepository(Success(railNetwork)),
    ...
    private fun samplePredictions(mode: TransportModeName): TransportResult<List<RailPredictionRecord>> =
